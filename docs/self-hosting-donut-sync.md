...
|---|---|---|---|
| `SYNC_TOKEN` | Yes | - | Bearer token used to authenticate requests from WaterMelon Browser clients |
...
## Configuring the WaterMelon Browser Client

1. Open WaterMelon Browser
