...
async fn run_profile(
  ...
  // Pro gate removed: launching profiles via the local API is allowed for all users.
...
async fn open_url_in_profile(
  ...
  // Pro gate removed: opening URLs via the local API is allowed for all users.
...
async fn kill_profile(
  ...
  // Pro gate removed: stopping profiles via the local API is allowed for all users.
