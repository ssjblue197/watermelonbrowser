...
GITHUB_REPO="ssjblue197/watermelonbrowser"
...
{
  echo "Origin: WaterMelon Browser"
  echo "Label: WaterMelon Browser"
  echo "Suite: stable"
...
echo "  echo 'deb [trusted=yes] https://repo.watermelonbrowser.com/deb stable main' | sudo tee /etc/apt/sources.list.d/watermelonbrowser.list"
echo "  sudo apt update && sudo apt install watermelon"
echo ""
echo "Users can add the RPM repo with:"
echo "  sudo tee /etc/yum.repos.d/watermelonbrowser.repo << 'EOF'"
echo "  [watermelonbrowser]"
echo "  name=WaterMelon Browser"
echo "  baseurl=https://repo.watermelonbrowser.com/rpm"
echo "  enabled=1"
echo "  gpgcheck=0"
echo "  EOF"
echo "  sudo dnf install Watermelon"
