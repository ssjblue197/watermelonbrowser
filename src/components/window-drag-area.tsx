      ...
      >
        {isFullscreen ? (
          ...
          >
            ...
            <path d="M4 1 V4 H1 M9 4 H6 V1 M6 9 V6 H9 M1 6 H4 V9" />
          </svg>
        ) : (
          <svg
            width="10"
            ...
            aria-label={t("common.window.fullscreen")}
          >
            {/* enter fullscreen: arrows pointing to corners */}
            <path d="M1 3.5 V1 H3.5 M6.5 1 H9 V3.5 M9 6.5 V9 H6.5 M3.5 9 H1 V6.5" />
          </svg>
        )}
      </button>
      <button
