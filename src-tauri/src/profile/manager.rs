...
mod tests {
  ...
  fn test_get_profiles_dir() {
    ...
    assert!(
      profiles_dir.to_string_lossy().contains("WaterMelonBrowser"),
      "Profiles dir should contain WaterMelonBrowser"
    );
    assert!(
  ...
  fn test_get_binaries_dir() {
    ...
    assert!(
      path_str.contains("WaterMelonBrowser"),
      "Binaries dir should contain WaterMelonBrowser"
    );
    assert!(
