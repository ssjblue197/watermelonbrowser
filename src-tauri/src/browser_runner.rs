...
impl BrowserRunner {
  ...
  pub async fn launch_browser_with_debugging(
    ...
    // Camoufox and Cloak start (and PID-reconcile) their own local proxy
  ...
  pub async fn kill_browser_process(
    ...
    // For non-camoufox/cloak browsers, use the existing logic
...
pub async fn launch_browser_profile_impl(
  ...
  // Launch browser or open URL in existing instance. Camoufox and Cloak
